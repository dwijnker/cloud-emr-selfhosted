...
import { ArrowLeft, Loader2, AlertCircle, Edit2, Trash2, Plus } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleDelete} disabled={deletePatientMutation.isPending} className="btn-outline text-red-600 hover:text-red-700">
