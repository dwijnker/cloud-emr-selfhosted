...
import { LayoutDashboard, LogOut, PanelLeft, Users, FileText, Heart, Calendar, Pill, Clipboard, AlertCircle, ClipboardList, MessageSquare, Stethoscope } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Stethoscope, label: "Staff", path: "/staff" },
];
